    ...
    <>
      <div className="relative h-screen max-sm:flex max-sm:flex-col max-sm:items-center max-sm:justify-center">
        ...
        <div className="px-20  max-md:px-10 max-sm:px-1 max-sm:p wrapper flex w-full h-screen max-md:h-fit max-sm:flex-col  max-sm:h-4/6 max-sm:justify-center max-sm:bg-black max-sm:bg-opacity-20">
          <div className="left flex flex-col w-1/2 mt-24 max-md:mt-12 max-md:w-10/12 max-sm:w-full max-sm:mt-0 max-sm:items-center
          max-sm:justify-evenly  max-sm:h-5/6">
            ...
            <p className="text-slate-400 font-normal w-6/6 mt-8 mb-7 max-md:w-6/6 max-sm:w-full max-sm:px-2 max-sm:text-base max-sm:tracking-wider ">
          ...
          <div className="right w-1/2 max-sm:w-full max-sm:justify-center  max-md:hidden max-sm:hidden">
